...
const EventItem = ({event, regformCount}: EventItemProps) => {
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="block cursor-pointer rounded-xl bg-gray-200/50 p-6 shadow transition-all
                active:bg-gray-200 dark:border-gray-700 dark:bg-gray-800 dark:active:bg-gray-700"
    >
      <div className="flex items-center justify-between gap-4">
        <div className="flex min-w-0 flex-col gap-1">
          ...
          <span
            className="mr-2 w-fit rounded-full bg-yellow-200 px-2.5 py-0.5 text-xs font-medium
        ...
        <div
          className="flex items-center rounded-full bg-blue-200 px-2.5 py-0.5 text-xs font-medium
